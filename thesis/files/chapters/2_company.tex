...
\end{itemize}
Il funzionamento del Gitflow Workflow viene mostrato nella figura \ref{fig:gitflow}.
...
\end{itemize}
Il funzionamento del framework Scrum viene mostrato nella figura \ref{fig:gitflow}.
...
La struttura della Kanban board è mostrata nella figura \ref{fig:kanban}.
