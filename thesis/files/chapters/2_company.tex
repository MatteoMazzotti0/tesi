...
\begin{itemize}
    ...
    \item i branch dedicati alle implementazioni di \textit{feature} vengono denominati con lo schema \textit{feature/<nome\_feature>};
    \item i branch dedicati ai \textit{bugfix} vengono denominati con lo schema \textit{fix/<nome\_bug>}.
\end{itemize}
Viene inoltre adottato lo standard \textit{Conventional Commits 1.0.0} per la scrittura dei messaggi di commit, in particolare
