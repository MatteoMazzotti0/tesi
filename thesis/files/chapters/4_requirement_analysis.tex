...
Prima di fare ciò sono stati definiti tutti i \textit{casi d'uso} del sistema.
\subsection{Attori individuati}
L'utente finale del sistema non utilizzerà direttamente il modulo di pianficazione, le sue funzionalità potranno essere messe a disposizione attraverso
...
\begin{table}[htbp]
    \centering
    \rowcolors{1}{}{tableGray}
    \begin{tabular}{|p{2.25cm}|p{7.75cm}|p{2.25cm}|}
    \hline
