...
La tabella \ref{tab:casi-uso} elenca i \textit{casi d'uso} individuati.
\vspace{0.5cm}
...
\begin{center}
\textbf{Tabella \thetable:} Tabella dei casi d'uso
\label{tab:casi-uso}
\end{center}
...
La tabella \ref{tab:mandatory-requirements} riassume i requisiti obbligatori individuati.
\begin{table}[htbp]
    \centering
...
La tabella \ref{tab:desirable-requirements} riassume i requisiti desiderabili individuati.
\begin{table}[htbp]
    \centering
    \rowcolors{1}{}{tableGray}
    \begin{tabular}{|p{2.25cm}|p{10cm}|}
...
La tabella \ref{tab:optional-requirements} riassume i requisiti facoltativi individuati.
\begin{table}[htbp]
    \centering
    \rowcolors{1}{}{tableGray}
    \begin{tabular}{|p{2.25cm}|p{10cm}|}
