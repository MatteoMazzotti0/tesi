...
\begin{figure}[H]
	...
	\caption{Duyiagramma di sequenza del funzionamento del sistema.}
	\label{fig:sequence}
\end{figure}
...
\begin{itemize}
    ...
    \item La soluzione viene restitutita all'\textit{API layer} il quale la invia al software gestionale.
\end{itemize}
