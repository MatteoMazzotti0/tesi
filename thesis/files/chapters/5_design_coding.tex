...
Nel suo insieme, il sistema è composto da due componenti principali e indipendenti:
\begin{itemize}
...
\begin{itemize}
    ...
    \item Il software gestionale invia una richiesta \textit{API} con le proprie credenziali al modulo di pianificazione, richiedendo il \textit{JSON Web Token};
    \item Il modulo di pianificazione valida le credenziali e risponde con il \textit{JSON Web Token};
    \item Il software gestionale invia una richiesta \textit{API} al modulo di pianificazione, richiedendo la pianificazione;
