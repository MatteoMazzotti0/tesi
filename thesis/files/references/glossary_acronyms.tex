...
\newglossaryentry{apig}{
    ...
    sort=api,
    description={In informatica un'Application Programming Interface (API) è un insieme di regole, contratti e punti di accesso che un componente software espone per consentire ad altri componenti o servizi di interagire in modo controllato, nascondendo i dettagli implementativi e semplificando l'integrazione tra sistemi eterogenei}
}
...
\newglossaryentry{clientg}{
    ...
    text={client},
    sort={client},
    description={Attore software o dispositivo che invia richieste a un servizio o \textit{API} remoto utilizzando credenziali come \texttt{client\_id} e \texttt{client\_secret}; può rappresentare applicazioni, integrazioni di terze parti o componenti interne autorizzate a consumare l'interfaccia esposta}
}
...
\newglossaryentry{inversioneControllog}{
    name={Inversione del controllo},
    text={inversione del controllo},
    sort={inversione del controllo},
    description={Principio architetturale secondo cui un componente non istanzia né gestisce direttamente le proprie dipendenze ma delega a un contenitore o infrastruttura esterna la responsabilità di fornirle, riducendo l'accoppiamento e facilitando test e sostituzione delle implementazioni}
}

\newglossaryentry{dependencyInjectiong}{
    name={Dependency Injection},
    text={dependency injection},
    sort={dependency injection},
    description={Tecnica concreta che realizza l'inversione del controllo fornendo a un componente le istanze delle sue dipendenze attraverso costruttori, metodi o parametri, tipicamente orchestrata da un contenitore che risolve e configura gli oggetti richiesti}
}

\newglossaryentry{businessLogicg}{
    name={Logica di business},
    text={logica di business},
    sort={logica di business},
    description={Insieme delle regole applicative e delle trasformazioni sui dati che implementano i requisiti del dominio, orchestrando servizi, repository e validazioni per garantire coerenza funzionale indipendentemente da presentazione e persistenza}
}
...
\newglossaryentry{multitenantg}{
    name={Multi tenant},
    text={multi tenant},
    sort={multitenant},
    description={Modello architetturale in cui un'unica istanza dell'applicazione serve più tenant isolati (organizzazioni o gruppi di utenti) condividendo infrastruttura e codice ma mantenendo separati dati e configurazioni, così da ottimizzare i costi e semplificare il rilascio}
}
...
\newglossaryentry{makespang}{
    name={Makespan},
    text={makespan},
    sort={makespan},
    description={Intervallo temporale complessivo necessario per completare tutte le attività pianificate, pari alla differenza tra l'avvio del primo lavoro e la conclusione dell'ultimo all'interno della schedulazione}
}

\newglossaryentry{objectiveFunctiong}{
    name={Funzione obiettivo},
    text={funzione obiettivo},
    sort={funzione obiettivo},
    description={Espressione che misura la qualità di una soluzione in un modello di ottimizzazione, da minimizzare o massimizzare nel rispetto dei vincoli definiti}
}

\newglossaryentry{unitTestg}{
    name={Test di unità},
    text={test di unità},
    sort={test di unita},
    description={Caso di test automatizzato che verifica in isolamento il comportamento di una singola unità di codice (ad esempio una funzione, un metodo o una classe), sostituendo le dipendenze esterne con stub o mock per concentrarsi esclusivamente sulla logica interna}
}

\newglossaryentry{functionalTestg}{
    name={Test funzionale},
    text={test funzionale},
    sort={test funzionale},
    description={Caso di test che verifica il comportamento osservabile del sistema rispetto ai requisiti funzionali, esercitando un flusso completo di utilizzo (ad esempio uno scenario di business) senza necessariamente coinvolgere tutti i componenti esterni reali}
}

\newglossaryentry{integrationTestg}{
    name={Test di integrazione},
    text={test di integrazione},
    sort={test di integrazione},
    description={Caso di test che verifica l'interazione corretta tra più componenti o sottosistemi (ad esempio modulo di schedulazione, accesso al database e servizi esterni), evidenziando problemi dovuti all'integrazione piuttosto che alla singola unità di codice}
}
\newglossaryentry{restg}{
    name={REST},
    text={REST},
    sort={rest},
    description={Acronimo di Representational State Transfer, è uno stile architetturale per sistemi distribuiti che definisce un insieme di vincoli per la creazione di servizi web scalabili, basati su risorse identificate da URI e manipolate tramite metodi HTTP standard (GET, POST, PUT, DELETE)}
}
